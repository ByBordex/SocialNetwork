...
public class NotaneitorTests {
	...
	public void PR06() { // Vamos al formulario de registro
		...
		PO_RegisterView.checkKey(driver, "Error.signup.lastName.length", PO_Properties.getSPANISH()); // Rellenamos el
																										// formulario
		PO_RegisterView.fillForm(driver, "99999990B", "Josefo", "Per", "77", "77");
		// Comprobamos que el apellido es corto
		PO_RegisterView.checkKey(driver, "Error.signup.password.length", PO_Properties.getSPANISH());
		// Rellenamos el formulario
		PO_RegisterView.fillForm(driver, "99999990B", "Josefo", "Per", "7777777", "1111111");
		// Comprobamos que el apellido es corto
	...
	public void PR11() {
		...
		PO_LoginView.fillForm(driver, "99999990A", "123456");
		PO_View.checkElement(driver, "text", "Notas del usuario");
		PO_HomeView.clickDesconectar(driver);
